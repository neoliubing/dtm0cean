...
/**
 * Created by bing.liu on 2015/2/4.
 */
public class DownloadApkActivity extends BaseActivity {

    public static final String DOWNLOAD_FOLDER_NAME = "DTM";
    public static final String DOWNLOAD_FILE_NAME = "dtm.apk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
             ...
             */
            APK_URL = getIntent().getStringExtra("link");
        }
...
//                request.setTitle(getString(R.string.download_notification_title));
                ...
                PreferencesUtils.putLong(DownloadApkActivity.this, KEY_NAME_DOWNLOAD_ID, downloadId);
                updateView();
            }
        });
