...
public class ScannerView extends View {
    ...
    public ScannerView(final Context context, final AttributeSet attrs) {
        ...
        maskColor = res.getColor(R.color.black);
        resultColor = res.getColor(R.color.green);
        final int laserColor = res.getColor(R.color.yellow);
        final int dotColor = res.getColor(R.color.white);
