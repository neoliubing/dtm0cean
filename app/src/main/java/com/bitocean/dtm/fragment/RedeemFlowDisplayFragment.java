 ...
 * @author bing.liu
 */
public class RedeemFlowDisplayFragment extends NodeFragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        LayoutInflater mInflater = LayoutInflater.from(getActivity());
        View v = mInflater.inflate(R.layout.fragment_redeem_flow_display, null);
        initView(v);
        return v;
    }
    ...
    private void initView(View v) {
        ...
        titleTextView.setText(R.string.redeem_flow_display);
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                RedeemScanQRFragment fragment = new RedeemScanQRFragment();
                getActivity()
                        ...
                        .addToBackStack("redeemflowdisplayfragment").commit();
            }
        });
